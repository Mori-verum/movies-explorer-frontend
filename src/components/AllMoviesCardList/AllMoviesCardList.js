...
function AllMoviesCardList(props) {
    ...
    const movies = props.movies.map(movie => {
        ...
        return (
            <AllMoviesCard isLiked={isLiked} savedMovies={props.savedMovies} handleDeleteMovie={props.handleDeleteMovie} handleSaveMovie={props.handleSaveMovie} card={movie} ></AllMoviesCard>
        )
    });
